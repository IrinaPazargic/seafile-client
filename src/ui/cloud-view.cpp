...
void CloudView::createTabs()
{
    ...
    tabs_->addTab(repos_tab_, QIcon(":/images/tabs/repos.png"), tr("Libraries"));

    starred_files_tab_ = new StarredFilesTab;
    tabs_->addTab(starred_files_tab_, QIcon(":/images/tabs/starred.png"), tr("Starred"));

    activities_tab_ = new ActivitiesTab;
    tabs_->addTab(activities_tab_, QIcon(":/images/tabs/activities.png"), tr("Activities"));
}
